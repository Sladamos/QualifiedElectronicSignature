...
public class XadesSignatureXmlWriter implements SignatureXmlWriter {
    ...
    public String toXml(SignatureInfo xmlInfo) {
        return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "\t\t<fileName>" + xmlInfo.sourceInfo().documentDetails().fileName().split("\\.")[0] + "</fileName>\n" +
                "\t\t<fileExtension>" + xmlInfo.sourceInfo().documentDetails().extension().strValue() + "</fileExtension>\n" +
